...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        questions[0][0] = "Array in java are?";
        questions[0][1] = "Object References";
        questions[0][2] = "Objects";
        questions[0][3] = "Primitive data type";
        questions[0][4] = "None";
        ...
        questions[2][0] = "Automatic type conversion is not possible in which of the possible cases?";
        ...
        questions[4][0] = "Number of primitive data types in java are.?";
        questions[4][1] = "3";
        questions[4][2] = "7";
        questions[4][3] = "8";
        questions[4][4] = "2";
        ...
        questions[7][0] = "equals() returns";
        questions[7][1] = "True False";
        questions[7][2] = "float value";
        ...
        questions[9][0] = "What will System.out.println(10 + 20 + \"Hello\"); output??";
        questions[9][1] = "10Hello";
        questions[9][2] = "20Hello";
        questions[9][3] = "30Hello";
        questions[9][4] = "20";

        answers[0][1] = "Objects";
        answers[1][1] = "32 and 64";
        answers[2][1] = "Long to Int";
        ...
        lifeline.setBounds(750, 700, 200, 30);
        ...
        submit.setBounds(1000, 700, 200, 30);
